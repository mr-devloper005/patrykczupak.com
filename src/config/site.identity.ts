export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'patrykczupak',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Patrykczupak',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'patrykczupak.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://patrykczupak.com',
